...
SensorData_local[6]=flex_3v3_1.read();
SensorData_local[7]=flex_3v3_2.read();


// Print the data
Serial.print(SensorData_local[0]);
Serial.print(" ");
Serial.print(SensorData_local[1]);
Serial.print(" ");
Serial.print(SensorData_local[2]);
Serial.print(" ");
Serial.print(SensorData_local[3]);
Serial.print(" ");
Serial.print(SensorData_local[4]);
Serial.print(" ");
Serial.print(SensorData_local[5]);
Serial.print(" ");
Serial.print(SensorData_local[6]);
Serial.print(" ");
Serial.println(SensorData_local[7]);
...
if (counter==100){
  Text_1[0] = Text_conversion(SensorData_local);
  counter==0;
